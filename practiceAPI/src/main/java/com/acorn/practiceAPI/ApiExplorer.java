...
public class ApiExplorer {
	public String getApiTest() throws IOException {
	    ...
	    urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=mWZ7ImGJU3yvsfDjy3z2KByK%2BNUSWGsOvnSwAkLAd9wUHt%2BUqyfdBs99HrHnZwK4Z%2BI1mXWhJvPNsx4K31Bc3w%3D%3D"); /*Service Key*/
